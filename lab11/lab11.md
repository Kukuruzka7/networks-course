...
#### Демонстрация работы
Они последовательными пересылками справились сделать себе нужные таблицы, это было не просто...


**Начало**

![](./img/routers-start.png)
...
#### Демонстрация работы
Вроде работает, если ребро 0 --- 1 заменить на 0, но если заменить на 100, то не получиться, я не смогла раздебагать((((
![](./img/router-3.png)
