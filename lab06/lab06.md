...
3. Значение в поле Length (Длина) – это длина чего?
   - размер всего пакет, то есть 8 байт хедера + полезная информация
4. Какое максимальное количество байт может быть включено в полезную нагрузку UDP-пакета?
   - $2^{16} - 1 - 8$, так как Length должно поместиться в 2 байта.
5. Чему равно максимально возможное значение номера порта отправителя?
   - $2^{16} - 1$, потому что Destination Port должен помещаться в 2 байта.
...
7. Проверьте UDP-пакет и ответный UDP-пакет, отправляемый вашим хостом. Определите
   ...
   - они поменялись местами: 53 и 61913 
   ![](./img/udp-ans.png)
...
**Я расшарила доступ к папке с домашними заданиям, получилось создать/удалить папки в TestUser**
...
#### Демонстрация работы
**У меня TestUser в целом смотрит на папку network-course, а программа смотрит на папку lab06.** 
1. Я перенесла файл с кодом ftp-client из networks-course/lab06 в networks-course
2. Я перенесла файл README.md из networks-course в networks-course/lab06
![](./img/ftp-server-files.png)
